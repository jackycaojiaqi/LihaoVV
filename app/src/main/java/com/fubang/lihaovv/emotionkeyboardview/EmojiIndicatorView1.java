package com.fubang.lihaovv.emotionkeyboardview;
 ...
 */
public class EmojiIndicatorView1 extends LinearLayout {
    ...
    public EmojiIndicatorView1(Context context) {
        this(context,null);
    }

    public EmojiIndicatorView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmojiIndicatorView1(Context context, AttributeSet attrs, int defStyleAttr) {
