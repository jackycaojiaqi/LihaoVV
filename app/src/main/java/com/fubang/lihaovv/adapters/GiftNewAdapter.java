 ...
 * 修改备注：
 */
public class GiftNewAdapter extends ListBaseAdapter<GiftNewEntity> {
    public GiftNewAdapter(List<GiftNewEntity> list, Context context) {
        super(list, context);
    }
    ...
    public View getItemView(int position, View convertView, ViewGroup parent) {
        ...
        holder.giftImage.setImageResource(list.get(position).getDate().getGiftImage());
        holder.giftName.setText(list.get(position).getDate().getGiftName());
        return convertView;
    }
