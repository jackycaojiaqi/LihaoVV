 ...
 */
public class HorizontalRecyclerviewAdapter1 extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter1.ViewHolder> {
    ...
    public HorizontalRecyclerviewAdapter1(Context context, List<ImageModel> datas){
        this.datas=datas;
