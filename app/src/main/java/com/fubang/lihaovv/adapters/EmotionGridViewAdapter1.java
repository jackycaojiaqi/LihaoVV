...
public class EmotionGridViewAdapter1 extends BaseAdapter {
	...
	public EmotionGridViewAdapter1(Context context, List<String> emotionNames, int itemWidth, int emotion_map_type) {
...
//			iv_emotion.setImageResource(R.drawable.emotion001);
			iv_emotion.setImageResource(EmotionUtils1.getImgByName(emotion_map_type,emotionName));
			Log.d("123","iv_emotion"+EmotionUtils1.getImgByName(emotion_map_type,emotionName));
		}
