 ...
 * 代理充值页面
 */
@EActivity(R.layout.activity_dai_recharge_acitivity)
public class DaiRechargeAcitivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener ,AsyncPayTask.PayCallBack{
    @ViewById(R.id.dai_recharge_back_btn)
    ImageView backImage;
    @ViewById(R.id.dai_recharge_confirm_btn)
    Button confirmBtn;
    @ViewById(R.id.dai_recharge_group)
    RadioGroup radioGroup;
    private int moneyB = 5;
    @ViewById(R.id.dai_recharge_5)
    RadioButton radioButton5;
    @ViewById(R.id.dai_recharge_10)
    RadioButton radioButton10;
    @ViewById(R.id.dai_recharge_20)
    RadioButton radioButton20;
    @ViewById(R.id.dai_recharge_50)
    RadioButton radioButton50;
    @ViewById(R.id.dai_recharge_100)
    RadioButton radioButton100;
    @ViewById(R.id.dai_recharge_200)
    RadioButton radioButton200;
    @ViewById(R.id.dai_recharge_user_tv)
    TextView userTv;
    @ViewById(R.id.dai_recharge_kbi_tv)
    TextView kbiTv;

    public final static String RETURNURL = "http://61.153.104.118:9418/index.php/Alipay/callbak_dai";
    ...
    @Override
    public void onClick(View v) {
        Toast.makeText(this, "确定充值"+moneyB+"元      暂不可用", Toast.LENGTH_SHORT).show();
