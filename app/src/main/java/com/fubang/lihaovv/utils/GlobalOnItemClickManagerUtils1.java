 ...
 */
public class GlobalOnItemClickManagerUtils1 {

    private static GlobalOnItemClickManagerUtils1 instance;
    private EditText mEditText;//输入框
    private static Context mContext;

    public static GlobalOnItemClickManagerUtils1 getInstance(Context context) {
        mContext=context;
        if (instance == null) {
            synchronized (GlobalOnItemClickManagerUtils1.class) {
                if(instance == null) {
                    instance = new GlobalOnItemClickManagerUtils1();
                }
            }
        }
        return instance;
