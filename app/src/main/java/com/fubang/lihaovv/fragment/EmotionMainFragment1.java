...
import com.fubang.lihaovv.adapters.HorizontalRecyclerviewAdapter1;
import com.fubang.lihaovv.adapters.NoHorizontalScrollerVPAdapter1;
import com.fubang.lihaovv.emotionkeyboardview.EmotionKeyboard1;
import com.fubang.lihaovv.emotionkeyboardview.NoHorizontalScrollerViewPager1;
import com.fubang.lihaovv.model.ImageModel;
import com.fubang.lihaovv.utils.EmotionUtils1;
import com.fubang.lihaovv.utils.GlobalOnItemClickManagerUtils1;
import com.fubang.lihaovv.utils.SharedPreferencedUtils1;
 ...
 * Description:表情主界面
 */
public class EmotionMainFragment1 extends DaseFragment {
    ...
    private HorizontalRecyclerviewAdapter1 horizontalRecyclerviewAdapter;
    //表情面板
    private EmotionKeyboard1 mEmotionKeyboard;
    ...
    //不可横向滚动的ViewPager
    private NoHorizontalScrollerViewPager1 viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_main_emotion1, container, false);
        isHidenBarEditTextAndBtn= args.getBoolean(EmotionMainFragment1.HIDE_BAR_EDITTEXT_AND_BTN);
        //获取判断绑定对象的参数
        isBindToBarEditText=args.getBoolean(EmotionMainFragment1.BIND_TO_EDITTEXT);
        initView(rootView);
        mEmotionKeyboard = EmotionKeyboard1.with(getActivity())
        ...
        initDatas();
        //创建全局监听
        GlobalOnItemClickManagerUtils1 globalOnItemClickManager= GlobalOnItemClickManagerUtils1.getInstance(getActivity());
    ...
    protected void initView(View rootView){
        viewPager= (NoHorizontalScrollerViewPager1) rootView.findViewById(R.id.vp_emotionview_layout);
...
//                    Toast.makeText(PageActivity.this, "---"+roomMessageEdit.getText(), Toast.LENGTH_SHORT).show();
    ...
    protected void initDatas(){
        ...
        //记录底部默认选中第一个
        CurrentPosition=0;
        SharedPreferencedUtils1.setInteger(getActivity(), CURRENT_POSITION_FLAG, CurrentPosition);

        //底部tab
        horizontalRecyclerviewAdapter = new HorizontalRecyclerviewAdapter1(getActivity(),list);
        ...
        horizontalRecyclerviewAdapter.setOnClickItemListener(new HorizontalRecyclerviewAdapter1.OnClickItemListener() {
            @Override
            public void onItemClick(View view, int position, List<ImageModel> datas) {
                //获取先前被点击tab
                int oldPosition = SharedPreferencedUtils1.getInteger(getActivity(), CURRENT_POSITION_FLAG, 0);
                //修改背景颜色的标记
    ...
    private void replaceFragment(){
        //创建fragment的工厂类
        FragmentFactory1 factory= FragmentFactory1.getSingleFactoryInstance();
        //创建修改实例
        EmotiomComplateFragment1 f1= (EmotiomComplateFragment1) factory.getFragment(EmotionUtils1.EMOTION_CLASSIC_TYPE);
        fragments.add(f1);
        Bundle b=null;
        //可去掉
        for (int i=0;i<1;i++){
        ...
        NoHorizontalScrollerVPAdapter1 adapter =new NoHorizontalScrollerVPAdapter1(getActivity().getSupportFragmentManager(),fragments);
