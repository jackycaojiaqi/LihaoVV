...
public class Header {
    public static final short MIC_STATUS_DOWN_MIC = 0x00000000;  //下麦状态(任何人可以连接)
    public static final short MIC_STATUS_PUBLIC_MIC = 0x00000001;  //公麦状态跳过排麦--夺麦、抱麦操作(任何人可以连接)
    public static final short MIC_STATUS_APPLICATE_MIC = 0x00000008;  //排麦状态 (申请发言麦序)

    public static final short MIC_STATUS_PRIVE_MIC = 0x00000002;  //私麦状态(任何人可以连接)
    public static final short MIC_STATUS_SECRET_MIC = 0x00000004;  //密麦状态(连接时只有好友自动通过连接,其他拒绝,这里现在都要要求验证同意)
    public static final short MIC_STATUS_CHARGE_MIC = 0x00000010;   //收费状态 (上了收费麦)
    ...
    public static final byte MessageType_mxpTradeGiftRequest = (byte) (6 + 14);//20
    ...
    public static final byte MessageType_mxpAddVcbToFavoriteRequest = (byte) (6 + 87); // 93
    public static final byte MessageType_mxpAddVcbToFavoriteResponse = (byte) (6 + 88); // 94 响应
    public static final byte MessageType_mxpSetRoomBKgroupNotify = (byte) (6 + 90); // 96
    public static final byte MessageType_mxpGetRoomMicListRequest = (byte) 106; // 106
    ...
    public static final byte MessageType_mxpGrabRedPagerRequest = (byte) (6 + 128); // 135
    public static final byte MessageType_mxpGrabRedPagerResponse = (byte) (6 + 129); // 135
    public static final byte MessageType_mxpRoomVideoRequest = (byte) 136;//设置房间管麦
    public static final byte MessageType_mxpRoomVideoNotify = (byte) 137;//设置房间管麦回调
//	public static final byte MessageType_mxpPreTradeGiftResponse = (byte)(6 + 131); // 137
    ...
    public static final byte MessageType_mxpRegisterRequest = (byte) (200 + 6); // 206
    public static final byte MessageType_mxpRegisterResponse = (byte) (200 + 7);  // 207
