 ...
 * 类描述：
 * 创建人：dell
 * 创建时间：2016-04-27 09:21
 * 修改人：dell
 * 修改时间：2016-04-27 09:21
 * 修改备注：
 */
public class PulltoRefreshHeadGridView extends PullToRefreshGridView{
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = PulltoRefreshHeadGridView.this.getMeasuredWidth()
                    - PulltoRefreshHeadGridView.this.getPaddingLeft()
                    - PulltoRefreshHeadGridView.this.getPaddingRight();
